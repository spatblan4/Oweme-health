create table if not exists findings (
  ...
  finding_type text not null check (finding_type in ('possible_credit', 'allocation_unclear', 'questionable_canceled_charge', 'claim_in_process', 'unmatched_payment', 'unassigned_medical_payment')),
